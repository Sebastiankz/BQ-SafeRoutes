...
├── docker-compose.yml    # Opcional: Postgres + Redis locales
...
Configura `DATABASE_URL` (y el resto) en `.env` en la raíz del repo o en `backend/.env`.
