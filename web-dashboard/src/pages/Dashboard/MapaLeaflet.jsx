...
const PUNTOS_CALOR = [
  ...
  [11.0183, -74.8066, 1.0], [11.0177, -74.8062, 1.0], [11.0170, -74.8058, 1.0],
  [11.0163, -74.8054, 1.0], [11.0156, -74.8050, 0.95],

  // ── Av. Circunvalar sector norte (Calle 98 - Calle 110) ──
  [11.0140, -74.8045, 0.9], [11.0120, -74.8038, 0.9], [11.0100, -74.8030, 0.85],
  [11.0080, -74.8025, 0.85],

  // ── Av. Circunvalar sector medio (Calle 72 - Calle 98) ──
  [11.0060, -74.8020, 0.8], [11.0040, -74.8015, 0.8], [11.0020, -74.8010, 0.75],
  [10.9995, -74.8005, 0.75], [10.9970, -74.8000, 0.7],

  // ── Calle 72 (corredor E-O) ──
  [10.9958, -74.8200, 0.65], [10.9958, -74.8100, 0.7], [10.9958, -74.8000, 0.75],
  [10.9958, -74.7900, 0.65],

  // ── Calle 30 / Vía 40 ──
  [10.9720, -74.8100, 0.5], [10.9720, -74.8000, 0.55], [10.9720, -74.7900, 0.5],
];
  ...
  useEffect(() => {
    ...
    import('leaflet.heat').then(() => {
      heat = L.heatLayer(PUNTOS_CALOR, {
        ...
        gradient: { 0.0: '#22c55e', 0.3: '#84cc16', 0.5: '#eab308', 0.7: '#f97316', 1.0: '#dc2626' },
      }).addTo(map);
    });
      ...
      <div className="flex items-center justify-between mb-3">
        ...
        <div className="flex items-center gap-3 text-[10px] text-slate-400 dark:text-gray-500">
          <span className="flex items-center gap-1">
            <span className="w-2 h-2 rounded-full bg-blue-400 inline-block"/> Bajo
          </span>
          <span className="flex items-center gap-1">
            <span className="w-2 h-2 rounded-full bg-yellow-400 inline-block"/> Medio
          </span>
          <span className="flex items-center gap-1">
            <span className="w-2 h-2 rounded-full bg-red-500 inline-block"/> Alto
          </span>
        </div>
      </div>
